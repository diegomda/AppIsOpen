...
using IsOpen.Services.IsOpen.Services;
...
namespace IsOpen.ViewModels
{
    public class LoginViewModel : INotifyPropertyChanged
    {
        ...
        private async void Login()
        {
            ...
            var token = await apiService.GetToken("http://isopenapi.azurewebsites.net", Email, Password);
            ...
            var response = await apiService.GetUserByEmail(
                "http://isopenapi.azurewebsites.net",
